...
While .T.
  ...
  ElseIf Loja = 67
     @ 17,01 Say "Aquiraz Cascavel                                                               "
  ElseIf Loja = 71
     @ 17,01 Say "Eusebio Aquiraz                                                                "
  ElseIf Loja = 73
     @ 17,01 Say "Eusebio Cascavel                                                               "
  Endif
  ...
  IF LASTKEY() = 27
     ...
     Release m_res,m_transit,m_autoriz,m_pendenc,wEletr
  ...
  While .T.
      ...
      ElseIf wDescontoFilialSup = .F.
         If Loja = 9 .and. m_datsi >= ctod("23/01/2023") .and. m_datsi <= ctod("31/03/2023")
            If m_grup = 1 .or. m_grup = 2 .or. m_grup = 3 .or. m_grup = 4 .or. m_grup = 16
      ...
      *@ 00,32 say "Localiz "+cd_local
      ...
      If w_faixap = 32 .or. w_faixap = 33  // Linha Infantil suspensa em 27/10/2022 (Michelle)
         w_faixap = 0
      Endif
      If w_faixap >0
         W_GR = "S"
	    ...
	    Endif
         Else
            If w_garant_36 >0 .and. m_gr <= 12
               @ 00,17 Say "Garantia Estendida (12) R$ "+str(w_garant_12,7,2)
               @ 01,17 Say "                   (24) R$ "+str(w_garant_24,7,2)
               @ 02,17 Say "                   (36) R$ "+str(w_garant_36,7,2)
            ElseIf w_garant_24 >0 .and. m_gr < 24
               @ 00,17 Say "Garantia Estendida (12) R$ "+str(w_garant_12,7,2)
               @ 01,17 Say "                   (24) R$ "+str(w_garant_24,7,2)
            Else
 	       @ 00,17 Say "Garantia Estendida (12) R$ "+str(w_garant_12,7,2)
      ...
      If !Eof()
       ...
       If XY_ESTOQODOO = "S"
          Stor 0 to M_AVARIA,M_AUTORIZ
       Endif

       Stor 0 to Centx,M_Pendenc,wTransit
       SD_Fisc(M_Codx,,,@Centx,@M_Pendenc,@wTransit,"pfile")
   ...
   If m_grup = 8
      ...
      SETCOLOR(cor)
      @ 05,41 SAY m_avista Pict "@E 999,999.99"
   ...
   Else
      ...
      If wDescontoFilialSup = .T.
         ...
         @ 06,39 Say "A Prazo 12 x"
         SETCOLOR(cor)
         @ 05,33 Say m_avista   Pict "@E 99,999.99"
         @ 05,col() Say cd_avista2 Pict "@E 99,999.99"
      Else
         @ 04,44 Say "A Vista"
         @ 06,39 Say "A Prazo 12 x"
         SETCOLOR(cor)
   ...
   If xy_cap_int = "CC"
      ...
      Else
         ...
         *? m_tx_cc
         *inkey(0)
         If M_GRUP = 1 .or. M_GRUP = 2 .or. M_GRUP = 3 .or. M_GRUP = 6 .or. M_GRUP = 9 .or. M_GRUP = 12 .or. M_GRUP = 13 .or. M_GRUP = 14 .or. M_GRUP = 15 .or. M_GRUP = 16 .or. M_GRUP = 17 .or. M_GRUP = 18 .or. M_GRUP = 19
            m_tx_cc = I_TXELECAP
         ElseIf M_GRUP = 8
   ...
   TemTaxa = .f.
   i_tx_cc = 0
   TaxaPromo(12,@i_tx_cc,@TemTaxa,m_grup,3)
   If TemTaxa = .t.
      m_tx_cc = i_tx_cc
   Endif
   ...
   If wDescontoFilialSup = .T.
      @ 04,19 SAY "A Faturar "+STRzero(wAfaturar,4)
      @ 05,19 SAY "Em Trƒns  "+STRZERO(M_TRANSIT,4)
      @ 06,19 SAY "Pendenc   "+STRZERO(M_PENDENC,4)
   Else
   ...
   Release datex,datex1,m_datw,m_res,wAfaturar

    cor=setcolor()
    SETCOLOR("gr+/b")
    If wDescontoFilialSup = .T.
       @ 07,19 say "Virtual   "+Str(CENTX,4)
    Else
   ...
   If Loja = 67                                   // Eusebio
      If cd_centl73 <0
         SETCOLOR("r/n")
      Endif
      @ 18,01 SAY CD_CENTL73 pict "9999999"
      SETCOLOR(cor)
      If cd_centl71 <0
         SETCOLOR("r/n")
      Endif
      @ 18,09 SAY CD_CENTL71 pict "9999999"
      SETCOLOR(cor)
   ElseIf Loja = 71                                       // Cascavel
      If cd_centl67 <0
         SETCOLOR("r/n")
      Endif
      @ 18,01 SAY CD_CENTL67 pict "9999999"
      SETCOLOR(cor)
      If cd_centl73 <0
         SETCOLOR("r/n")
      Endif
      @ 18,09 SAY CD_CENTL73 pict "9999999"
      SETCOLOR(cor)
   ElseIf Loja = 73                                   // Aquiraz
      If cd_centl67 <0
         SETCOLOR("r/n")
      Endif
      @ 18,01 SAY CD_CENTL67 pict "9999999"
 ...
 ELseIf Loja = 20
    ...
    setcolor("bg+/b")
    Stor 0 to cd_centl8,cd_centl18,cd_centl22,cd_centl33,cd_centl62
...
*@ 22,57 say m_totx pict "9999999"
 ...
 IF TEC = -1      && fatores para Calculo
	...
	SETCOLOR("W+/BG+, B/RG,X")
	   ...
	   If w_garant_36 >0
              @ 18,14 clear to 20,73
              @ 18,14 to 20,73
              @ 19,15 prom "C/Garantia(36)" 
              @ 19,31 prom "C/Garantia(24)" 
              @ 19,47 prom "C/Garantia(12)" 
	      @ 19,62 prom "S/Garantia" 
	      Menu to w_opc
	      If w_opc = 1
 	         w_vrgr = w_garant_36
	      ElseIf w_opc = 2
 ...
 */
   ...
   If xy_cap_int = "IN" .and. m_datsi >= ctod("01/01/2023") .and. m_tipo = 5     // Cartao de Credito
      If m_grup = 1 .or. m_grup = 2 .or. m_grup = 3 .or. m_grup = 4 .or. m_grup = 15 .or. m_grup = 16
         m_tx_cc = 2.92
      ElseIf ((m_grup = 7 .or. m_grup = 8) .and. (m_parc <= 10 ))
         m_tx_cc = 0
      Endif
   Endif
   ...
   TemTaxa = .f.
   i_tx_cc = 0
   TaxaPromo(m_parc,@i_tx_cc,@TemTaxa,m_grup,3)
   If TemTaxa = .t.
      m_tx_car = i_tx_cc
   Endif
   ...
   TemTaxa = .f.
   i_tx_cc = 0
   TaxaPromo(m_parc,@i_tx_cc,@TemTaxa,m_grup,5)
   If TemTaxa = .t.
      m_tx_cc = i_tx_cc
   Endif
